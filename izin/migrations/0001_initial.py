    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepts', models.ManyToManyField(related_name='accept', to=settings.AUTH_USER_MODEL, verbose_name='Kabul')),
                ('vetos', models.ManyToManyField(related_name='veto', to=settings.AUTH_USER_MODEL, verbose_name='Red')),
            ],
        ),
    ]
